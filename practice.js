const loadProducts = () => {
      ...
      div.innerHTML = `<div class="single-product">
        <div>
          <div class="">
            ...
            <div class="card-body">
              <h4 class="text-primary card-title">${product?.title}</h4>
              <p class="card-text fst-italic fw-normal text-black">Category: ${product?.category}</p>
              <h2 class="text-black">Price:$${product?.price}</h2>
        <h5>Rating: <span class="text-danger">${product.rating.rate}</span><br> Rate Count: <span class="text-danger">${product.rating.count}</span> <h5>
            </div>
            <div >
              <small class="text-muted">  <button onclick="addToCart(${product?.id},${product?.price})" id="addToCart-btn" class="buy-now btn btn-danger">add to cart</button>
              <button id="details-btn" class="btn btn-primary">Details</button></div></small>
            </div>
          </div>
        </div>
 ...
 StereoPannerNode.onclick=function()
 {
